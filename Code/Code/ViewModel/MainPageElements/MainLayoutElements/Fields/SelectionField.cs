...
namespace App2.ViewModel.MainPageElenents.MainLayoutElements.Fields
{
    public class SelectionField : BaseView
    {
        ...
        protected override void Compose()
        {
            ...
            stackLayout.Children.Add(new ConverterButton(MainField, MainField.CodeField.MainBlockView.BlockElementsHolder, ElderCodeBlock.Main).GetView());
            stackLayout.Children.Add(new SwapButton(MainField, MainField.CodeField.MainBlockView.BlockElementsHolder, ElderCodeBlock.Main).GetView());
