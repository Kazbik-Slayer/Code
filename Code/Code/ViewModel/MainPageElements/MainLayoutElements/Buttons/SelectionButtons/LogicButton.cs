...
namespace App2.ViewModel.MainPageElenents.MainLayoutElements.Buttons.SelectionButtons
{
    public class LogicButton : BaseView
    {
        ...
        public LogicButton(MainField MainField, StackLayout layoutToAddUnit, Button replaceButton = null)
        {
            ...
            Button.Clicked += (s, e) =>
            {
                ...
                layoutToAddUnit.Children.Add(new LogicBlockView(MainField).GetView());
