...
namespace App2.ViewModel.MainPageElenents.MainLayoutElements.Buttons.SelectionButtons
{
    ...
    {
        Button Button;
        public ArrayButton(MainField mainField, StackLayout layoutToAddUnit, CodeBlock codeBlock, Button replaceButton = null)
        {
            ...
            Button.Clicked += (sender, e) =>
            {
                ...
                layoutToAddUnit.Children.Add(new ArrayView(mainField, layoutToAddUnit, codeBlock).GetView());
